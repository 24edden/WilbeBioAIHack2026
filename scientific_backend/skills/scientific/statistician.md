...
Assess whether a proposed falsification could meaningfully detect the hypothesized effect at the correct experimental unit and scale. Nonsignificance, low power or a wide interval cannot justify `clearly_ruled_out`; require accepted counterevidence and a defensible exclusion criterion appropriate to the claimed effect. Do not invent an equivalence margin or probability for the ledger states. Report uncertainty, QC/design constraints and expected support/weakening/inconclusive outcomes for the next contrast. Keep hypothesis IDs and scope intact in recommendations to clinical/translational science; coordinator/reviewer decide the authoritative ledger state.
