...
Expression, cell-state, exposure, clinical timing and statistical analyses remain necessary alongside molecular modeling. See Scientific evidence and R&D handoff (app document: `/home/ubuntu/rosalind-hackathon-demo/docs/SCIENCE.md`; outside this GitHub documentation collection) for the case-specific evidence boundaries.
...
For accepted runs, preserve request parameters, provider/model identity, every returned structure, validation results, raw response artifacts and source hashes. Keep predictions separate from measurements. See runtime skills (app document: `/home/ubuntu/rosalind-hackathon-demo/docs/SKILLS.md`; outside this GitHub documentation collection) and provider contracts (app document: `/home/ubuntu/rosalind-hackathon-demo/docs/PROVIDERS.md`; outside this GitHub documentation collection).
...
- Project scientific scope (app document: `/home/ubuntu/rosalind-hackathon-demo/docs/SCIENCE.md`; outside this GitHub documentation collection)
- Scientific skills used at runtime (app document: `/home/ubuntu/rosalind-hackathon-demo/docs/SKILLS.md`; outside this GitHub documentation collection)
